...
vehicle_specs = {
    'Sub Compacto': {'mass': 800, 'fuel_eco': 10.5, 'fuel_eco_e27':13.3},
    'Compacto': {'mass': 1000, 'fuel_eco': 9.5, 'fuel_eco_e27':13.3},
    'Médio': {'mass': 1200, 'fuel_eco': 8.6, 'fuel_eco_e27':13.3},
    'Grande': {'mass': 1450, 'fuel_eco': 7.8, 'fuel_eco_e27':13.3},
    'Extra Grande': {'mass': 1700, 'fuel_eco': 7.1, 'fuel_eco_e27':13.3},
    'Onix 2024': {'mass': 1034, 'fuel_eco_e100': 9.3, 'fuel_eco_e27':13.3}
}
#C:\Users\bernardo.cossetin\Desktop\ProjetoH2\App_H2\
...
st.sidebar.markdown(
    ...
    <div style="
        ...
        <h3 style="font-size:20px;margin-top:0;">ICEV</h3>
    </div>
    """,
    unsafe_allow_html=True
)
...
with st.sidebar.container():
    ...
    <div style='font-size:16px; font-weight:bold; display:flex; align-items:center; gap:6px; margin-bottom:-25px;'>
        ...
        <div class="tooltip-container">ⓘ
            <div class="tooltip-text">Fuel type. Changes specific emissions and default fuel economy. Use E100 for ethanol and E27 for gasoline.</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
if fe_pad:
    if tipo == 'E100':
        fuel_eco = vehicle_specs[veh_cat]['fuel_eco_e100']
    else:
        fuel_eco = vehicle_specs[veh_cat]['fuel_eco_e27']
