...
with tabs[1]:
    ...
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348609/Side-bar2_mb3qiu.png', width=525)
    st.markdown('''All form elements include a tooltip icon ('ⓘ') located on the right side of the input container title. This tooltip provides a brief description of the corresponding input field.  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348609/Side-bar3_qscttf.png', width=600) 
    st.markdown('''The fields with a toggle for default values display the equivalent value of the vehicle stored in our database.  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348609/Side-bar4_xwr5ue.png', width=500)
    st.markdown('''**Type**:  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348610/Side-bar5_kyhfno.png', width=500)
    st.markdown('''**Category**:  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348610/Side-bar6_c1jw2o.png', width=500)
    st.markdown('''**Vehicle Cost**:  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348610/Side-bar7_bgkkeu.png', width=300)
    st.markdown('''**Fuel Eco**:  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348611/Side-bar8_ptrthd.png', width=800)
    st.markdown('''**Years**:  
                This field defines the **vehicle’s lifetime**, which can be adjusted using the slider from 1 to 20 years.  
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348611/Side-bar9_v8eqtb.png', width=300)
    st.markdown('''**Yearly Mileage**:  
                This field indicates the total distance driven by the vehicle per year, measured in **kilometers**.  
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348611/Side-bar10_jc0h71.png', width=300)
    st.markdown('''**UF**:
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348611/Side-bar11_cc9su4.png', width=300)
    st.markdown('''**Battery Capacity**:  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348611/Side-bar12_b1puqp.png', width=300)
...
with tabs[2]:
    st.markdown('''When the comparison page is opened, a message appears on the screen indicating the usage condition of the tool: it can only be used  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348609/Comparison1_uqlkmu.png')
    st.markdown(''' In addition, since the purpose of this page is to compare multiple vehicles, the selected currency applies to all values across all vehicles.  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348609/Comparison2_v1mio4.png',width=500)
    st.markdown('''The comparison function offers multiple possibilities to compare different vehicle types with different fuel options.  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348609/Comparison3_we5csy.png')
...
with tabs[3]:
    st.markdown('''**ICEV, BEV, and FCEV – Charts and Output Data**  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348610/Results1_nqy7bq.png', width=600)
    st.markdown('''The container that displays the charts is organized as a tab component, which includes both the emissions chart and the accumulated TCO chart.   
                ...
                ''')       
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348610/Results2_wtfrpt.png', width=600)
    st.markdown('''The TCO chart, in turn, starts its index at year 1 and extends to the final year, showing a flattening and decline toward the end.  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348610/Results3_mceoro.png', width=600)
    st.markdown('''Next to the charts, the numerical results for GHG, GHG/km, TCO, and LCOD are displayed. Each result includes a tooltip providing a brief explanation of its meaning. 
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348610/Results4_osv1ko.png', width=200)
    st.markdown('''The numerical values used in the calculations can be checked in the collapsible table located just below the results section.
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762348610/Results5_epwobm.png', width=400)
    st.markdown('''**Comparison – Charts and Output Data**  
                ...
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762781129/37_yqtqo5.png')
    st.markdown('''Each vehicle category is represented as a line with a distinct color in the chart, with a corresponding label in the legend next to it.  
                To filter the results, simply click on the legend to toggle the visibility of the respective line in both charts.
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762781130/36_vgfyrt.png')
    st.markdown('''In addition, for any chart displayed on the platform, it is possible to switch to full-screen mode simply by clicking the button located above the chart.
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762781129/38_krp0av.png')
    st.markdown('''Another useful tool for improving visualization—especially in comparison mode—is the zoom-in feature. By clicking, holding, and dragging over a specific area, that section will be magnified.  
                To return to the original view, simply double-click anywhere on the chart.
                ''')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762781129/39_ksuziy.png')
    st.image('https://res.cloudinary.com/dg4qs0bnq/image/upload/v1762781130/40_oztita.png')            
