...
with st.sidebar.container():
    ...
    """, unsafe_allow_html=True)
    veh_cat = st.sidebar.selectbox("", list(vdb_ICEV.columns))
...
W = vdb_ICEV[veh_cat]['Vehicle Mass [kg]']
if fe_pad:
    if tipo == 'E100':
        fuel_eco = vdb_ICEV[veh_cat]['Ethanol Fuel Economy [km/L]']
    else:
        fuel_eco = vdb_ICEV[veh_cat]['Gasoline Fuel Economy [km/L]']
