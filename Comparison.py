...
with st.sidebar.container():
    ...
    main_filter_comparison = st.sidebar.multiselect(
            "",
            ["ICEV with Ethanol", "ICEV with Gasoline", "BEV", "FCEV"])
...
category_styles = {
    "ICEV with Ethanol": {"bg": "#484848", "border": "#D41216"},
    "ICEV with Gasoline": {"bg": "#484848", "border": "#D41216"},
    "BEV": {"bg": "#484848", "border": "#D41216"},
    "FCEV": {"bg": "#484848", "border": "#D41216"}
}
...
if len(main_filter_comparison) < 2:
    ...
    inputs = {'ICEV with Ethanol': {}, 'ICEV with Gasoline': {}, 'FCEV': {}, 'BEV': {}}
